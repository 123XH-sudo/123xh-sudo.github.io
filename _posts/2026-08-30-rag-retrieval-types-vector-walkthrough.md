...
> | Phase 3 系列 | [types + vector]({% post_url 2026-08-30-rag-retrieval-types-vector-walkthrough %}) → [corpus + bm25]({% post_url 2026-08-30-rag-retrieval-corpus-bm25-walkthrough %}) → [hybrid]({% post_url 2026-08-31-rag-retrieval-hybrid-walkthrough %}) → [rerank + engine]({% post_url 2026-08-31-rag-retrieval-reranker-engine-walkthrough %}) → [收官]({% post_url 2026-08-31-rag-retrieval-search-eval-phase3-summary %}) |
...
下一篇：**[corpus.py + bm25.py 带读]({% post_url 2026-08-30-rag-retrieval-corpus-bm25-walkthrough %})** —— 关键词检索、lru_cache、zip 与 enumerate。
