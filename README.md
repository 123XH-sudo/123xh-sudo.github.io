...
**当前阶段**：阶段 2 知识库构建 ✅（已验证）→ **阶段 3 检索系统** 🚧 进行中
...
python -m app.retrieval.search "Docker" --mode hybrid --top-k 3
python eval/run_eval.py                                         # Recall 评测
python scripts/verify_retrieval.py                              # smoke test
```
